...
from exact_duplicates import scan_duplicates,remove_duplicates,skip_removed_duplicate,REGISTRY,pixels
...
class ExactDuplicateTests(unittest.TestCase):
    ...
    def test_recheck_annotations_pixels_and_failed_registry_write(self):
        ...
        with patch('exact_duplicates.write_registry',side_effect=OSError('disk full')):
    ...
    def test_hash_collision_is_not_enough_and_paths_cannot_escape_collection(self):
        ...
        with patch('exact_duplicates.hashlib.sha256',return_value=Collision()):
