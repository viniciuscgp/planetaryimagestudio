...
from planetary_studio.collections.exact_duplicates import scan_duplicates,remove_duplicates,REGISTRY
...
class DuplicateDialog(QDialog):
    def __init__(self,host,monochrome=False):
        ...
        if monochrome:
            from planetary_studio.collections.monochrome_cleanup import scan_monochrome,remove_monochrome
