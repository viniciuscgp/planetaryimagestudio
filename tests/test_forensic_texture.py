...
from planetary_studio.processing.forensic_texture_analyzer import ForensicTextureAnalyzer, METRICS
from planetary_studio.ui.forensic_texture_ui import ForensicTextureDialog, highlight_texture, strongest_mask, spotlight_texture
from planetary_studio.processing.forensic_texture_presentation import RegionPresentation, category
...
class TextureUITests(unittest.TestCase):
    ...
    def test_export_buttons_preserve_source_and_use_distinct_folders(self):
        with tempfile.TemporaryDirectory() as folder:
            ...
            with patch('planetary_studio.ui.forensic_texture_ui.QFileDialog.getExistingDirectory',return_value=folder), \
                 patch('planetary_studio.ui.forensic_texture_ui.QMessageBox.information'):
...
class TextureIntegrationTests(unittest.TestCase):
    ...
    def test_menu_toolbar_open_preserves_viewer_and_edit_state(self):
        ...
        from planetary_studio.annotations.annotation_editing import image_transform
