...
from planetary_studio.processing.morphological_region_analyzer import MorphologicalRegionAnalyzer
from planetary_studio.ui.morphological_region_ui import annotation_mask, marked_regions, MorphologicalRegionDialog
...
class MorphologyUITests(unittest.TestCase):
    ...
    def test_no_selection_message_and_action_preserves_edits(self):
        path = self.image(1,'morphology.png');window = self.window()
        with patch('planetary_studio.app.QMessageBox.information') as message:
