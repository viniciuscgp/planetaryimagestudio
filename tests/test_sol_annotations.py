...
class SolAnnotationTests(unittest.TestCase):
    ...
    def test_switch_sols_with_large_images_and_real_fit_events(self):
        ...
        with patch('planetary_studio.app.QTimer.singleShot', side_effect=lambda delay, callback:
    ...
    def test_scan_does_not_block_startup_and_ignores_stale_result(self):
        ...
        with patch('planetary_studio.annotations.sol_annotations.folder_marked', side_effect=slow_scan):
            try:
                window = self.window()
