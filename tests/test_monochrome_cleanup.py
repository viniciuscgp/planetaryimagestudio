...
from planetary_studio.collections.exact_duplicates import REGISTRY,skip_removed_image,scan_duplicates,remove_duplicates
from planetary_studio.collections.monochrome_cleanup import is_monochrome,scan_monochrome,remove_monochrome
...
class MonochromeTests(unittest.TestCase):
    ...
    def test_revalidation_and_registry_failure_keep_original(self):
        ...
        with patch('planetary_studio.collections.monochrome_cleanup.write_registry',side_effect=OSError('disk full')):
