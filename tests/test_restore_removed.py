...
from planetary_studio.collections.exact_duplicates import REGISTRY,write_registry
...
from planetary_studio.sources.archives import ArchiveWorker,ArchiveProvider,STATE_FILE,collection_id
...
class RestoreUITests(unittest.TestCase):
    ...
    def test_save_failure_or_active_download_preserves_registry(self):
        ...
        with patch.object(window,'_save_state',return_value=False), \
             patch('planetary_studio.app.QMessageBox.warning') as warning,patch.object(window,'_launch_downloader') as launch:
        ...
        with patch.object(window,'_download_thread',Mock()),patch('planetary_studio.app.QMessageBox.information'), \
