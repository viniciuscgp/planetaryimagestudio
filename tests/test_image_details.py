...
from planetary_studio.processing.image_adjustments import apply_adjustments,AdjustmentDialog
from planetary_studio.annotations.image_annotations import AnnotationDocument,empty_state
...
class DetailTests(unittest.TestCase):
    ...
    def test_brightness_dialog_persistence_undo_and_defaults(self):
        ...
        with patch('planetary_studio.app.AdjustmentDialog') as dialog_type:
