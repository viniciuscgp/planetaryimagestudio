...
import tests.test_image_annotations as annotations
...
from planetary_studio.annotations.annotation_editing import drawing_shape
...
class EditingTests(unittest.TestCase):
    ...
    def test_rotated_text_move_resize_edit_and_delete(self):
        ...
        with patch("planetary_studio.annotations.annotation_editing.QInputDialog.getText", return_value=("Novo alvo", True)):
    ...
    def test_region_copy_export_contains_rendered_pixels_only(self):
        ...
        with patch("planetary_studio.annotations.annotation_editing.QFileDialog.getSaveFileName", return_value=(str(exported), "PNG")):
