...
class MissionTests(unittest.TestCase):
    ...
    def test_toolbar_selects_mission_without_folder_prompt(self):
        ...
        with patch('app.QFileDialog.getExistingDirectory', side_effect=AssertionError('Unexpected folder prompt')):
    ...
    def test_enabling_auto_download_starts_current_mission(self):
        ...
        with patch('app.MissionSettingsDialog') as dialog_type, patch('app.QTimer.singleShot') as timer:
    ...
    def test_config_change_preserves_existing_files(self):
        ...
        with patch('app.MissionSettingsDialog') as dialog_type:
            dialog = dialog_type.return_value
            dialog.exec.return_value = QDialog.DialogCode.Accepted
            dialog.registry = changed
